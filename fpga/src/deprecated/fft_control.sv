// fft_control.sv - Controller and AGU
...
module reverse_bits (input logic [8:0] bits_in, output logic [8:0] bits_out);
    assign bits_out = {bits_in[0], bits_in[1], bits_in[2], bits_in[3], bits_in[4], bits_in[5], bits_in[6], bits_in[7], bits_in[8]};
endmodule
