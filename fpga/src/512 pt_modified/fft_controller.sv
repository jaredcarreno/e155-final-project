...
module fft_controller (
    ...
    output logic [8:0]  out_addr_probe // NEW PORT
);
    logic			    write_0, write_1;
    logic [5:0] fft_level;
    // Note: butterfly_iter needs to be [8:0] (fixed in sub-module below)
