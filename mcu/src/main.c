...
// Configuration for single buffer
//void  DMA_Config (volatile uint32_t srcAdd, volatile uint32_t destAdd, volatile uint16_t size)
//{
...
//void process_block(uint16_t *block, uint32_t size)
//{
//    // Example: compute average (or whatever processing you want)
//    uint32_t sum = 0;
...
//    printf("Processing block avg: %.3f\n", avg);
//}
